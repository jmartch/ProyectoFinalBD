            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Gestionar los días festivos del calendario
                  </CardDescription>
                </div>
                ...
                <TableBody>
                  {holidays.map((holiday) => (
                    <TableRow key={holiday.id}>
                      <TableCell>
                        {holiday.date.toLocaleDateString('es-CO')}
                      </TableCell>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Calendario de semanas para el seguimiento del programa (se crea una sola
                    vez)
                  </CardDescription>
                </div>
                  ...
                  <TableBody>
                    {programWeeks.slice(0, 10).map((week) => (
                      <TableRow key={week.id}>
                        ...
                        <TableCell>
                          {week.startDate.toLocaleDateString('es-CO')}
                        </TableCell>
                        <TableCell>
                          {week.endDate.toLocaleDateString('es-CO')}
                        </TableCell>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Gestionar tipos de documentos de identidad
                  </CardDescription>
                </div>
                <Button>
                  <Plus className="w-4 h-4 mr-2" />
