    ...
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl mb-2">
          {isAdmin ? 'Panel Admin' : 'Panel de Inicio'}
        </h2>
      ...
      {/* Aulas Details - Solo para tutores, no para admins */}
      {!isAdmin && insideClassroomAulas.length > 0 && (
        <div>
      ...
      {!isAdmin && outsideClassroomAulas.length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-4">
      ...
      {/* Solo mostrar mensaje de "sin aulas" para tutores, no para admins */}
      {!isAdmin && tutorAulas.length === 0 && (
        <Card>
